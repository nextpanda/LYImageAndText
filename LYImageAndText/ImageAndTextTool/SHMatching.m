...
+(NSArray*)urlRangeArrWithString:(NSString*)string
{
    ...
    NSArray *rangeArr = [SHMatching rangeArrWithString:string andMatchingString:regulaStr];
    return rangeArr;
}
...
+(NSArray*)urlArrWithString:(NSString*)string
{
    ...
    NSArray *urlStr_Arr = [SHMatching subRangeStringWithString:string andRangeArr:rangeArr];
...
{
    NSArray *phoneRange_Arr = [SHMatching phoneNumRangeArrWithString:string];
    NSArray *phoneNum_Arr = [SHMatching subRangeStringWithString:string andRangeArr:phoneRange_Arr];
    return phoneNum_Arr;
}
...
+(NSArray*)phoneNumRangeArrWithString:(NSString*)string
{
    ...
    NSArray *phoneNumberRange_Arr = [SHMatching rangeArrWithString:string andMatchingString:regulaStr];
...
{
    NSArray *emailRange_Arr = [SHMatching emailRangeArrWithString:string];
    NSArray *email_Arr = [SHMatching subRangeStringWithString:string andRangeArr:emailRange_Arr];
    return email_Arr;
}
...
+(NSArray*)emailRangeArrWithString:(NSString*)string
{
    ...
    NSArray *emailRange_Arr = [SHMatching rangeArrWithString:string andMatchingString:regulaStr];
